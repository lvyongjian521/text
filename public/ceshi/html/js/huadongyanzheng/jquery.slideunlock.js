...
function SliderUnlock(elm, options, success, always) {
    ...
    var opts = {
        labelTip: typeof(options.labelTip)!=="undefined" ? options.labelTip : "请按住滑块，拖动到最右边",
        successLabelTip: typeof(options.successLabelTip)!=='undefined' ? options.successLabelTip : "验证成功!",
